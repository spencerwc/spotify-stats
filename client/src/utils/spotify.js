...
export const getUserTopArtists = (timeRange = 'long_term') => axios.get(`https://api.spotify.com/v1/me/top/artists?time_range=${timeRange}`);

export const getUserFollowedArtists = () => axios.get(`https://api.spotify.com/v1/me/following?type=artist`);
